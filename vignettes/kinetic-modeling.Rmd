...
(PlotGeneKinetics(sars,"SRSF6",bare.plot=T)|PlotGeneKinetics(sars,"SRSF6",ntr.fit = T,bare.plot=T))/
  (PlotGeneKinetics(sars,"SRSF6",use.old=ColData(sars)$Name!="SARS.no4sU.A",bare.plot=T)|PlotGeneKinetics(sars,"SRSF6",steady.state=list(Mock=TRUE,SARS=FALSE),bare.plot=T))
```
