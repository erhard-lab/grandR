...
PlotScatter(df,"kinetics.Mock.Half-life","kinetics.SARS.Half-life",log=T)+geom_abline()
```
...
SetParallel()
sars<-CalibrateTimes(sars,steady.state = c(Mock=T,SARS=F))
PlotGeneKinetics(sars,"MYC",steady.state = c(Mock=T,SARS=F)) | PlotGeneKinetics(sars,"MYC",time = "norm_time",steady.state = c(Mock=T,SARS=F))
...
```{r}
df<-cbind(
  GetAnalysisTable(sars,c("kinetics.Mock"),columns="Half-life",regex=FALSE,gene.info = FALSE),
  GetAnalysisTable(sars,c("norm_kinetics.Mock"),columns="Half-life",regex=FALSE,gene.info = FALSE),
  GetAnalysisTable(sars,c("ntr_kinetics.Mock"),columns="Half-life",regex=FALSE,gene.info = FALSE),
  GetAnalysisTable(sars,c("normntr_kinetics.Mock"),columns="Half-life",regex=FALSE,gene.info = FALSE),
  GetAnalysisTable(sars,c("lm_kinetics.Mock"),columns="Half-life",regex=FALSE,gene.info = FALSE)
  )
