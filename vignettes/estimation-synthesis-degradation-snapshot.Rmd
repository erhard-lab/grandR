...
values.d <- log2(anal.table$true_d.perturbed.d/anal.table$true_d)

upper.s <- anal.table$`Regulation.s vs control.HL.cred.upper`
lower.s <- anal.table$`Regulation.s vs control.HL.cred.lower`
...
ggroc(list(roc.rope.old.d, roc.deseq.old.d), legacy.axes = TRUE)
```
...
ggroc(list(roc.rope.new.d, roc.deseq.new.d), legacy.axes = TRUE)
```
...
ggroc(list(roc.rope.old.s, roc.deseq.old.s), legacy.axes = TRUE)
```
...
ggroc(list(roc.rope.new.s, roc.deseq.new.s), legacy.axes = TRUE)
