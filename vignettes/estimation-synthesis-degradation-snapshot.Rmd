...
```{r}
# Get new analysis table and take a look at the columns
anal.table.reg2 <- GetAnalysisTable(m2)
colnames(anal.table.reg2)

# PlotScatter on estimates vs true sigma/delta; slope should be 1, meaning no bias

true.s.lfc.filtered <- log2(GeneInfo(m2)$true_s.perturbed.s/GeneInfo(m2)$true_s)
est.s.lfc.filtered <- anal.table.reg2$`Regulation.s vs control.s.log2FC`

true.hl.lfc.filtered <- -log2(GeneInfo(m2)$true_d.perturbed.d/GeneInfo(m2)$true_d)
est.hl.lfc.filtered <- anal.table.reg2$`Regulation.HL vs control.HL.log2FC`
...
(I think it looks a bit better, but should really annotate with the slope number.)
...
library(ggplot2)
library(reshape2)
box.hl <- data.frame(unperturbed.vs.control = anal.table.reg$`Regulation.unperturbed vs control.HL.log2FC`,
                     hl.vs.control = anal.table.reg$`Regulation.HL vs control.HL.log2FC`,
                     s.vs.control = anal.table.reg$`Regulation.s vs control.HL.log2FC`)
...
```{r}
box.s <- data.frame(unperturbed.vs.control = anal.table.reg$`Regulation.unperturbed vs control.s.log2FC`,
                     hl.vs.control = anal.table.reg$`Regulation.HL vs control.s.log2FC`,
                     s.vs.control = anal.table.reg$`Regulation.s vs control.s.log2FC`)
...
```{r}
box.hl.filtered <- data.frame(unperturbed.vs.control = anal.table.reg2$`Regulation.unperturbed vs control.HL.log2FC`,
                     hl.vs.control = anal.table.reg2$`Regulation.HL vs control.HL.log2FC`,
                     s.vs.control = anal.table.reg2$`Regulation.s vs control.HL.log2FC`)
...
```{r}
box.s.filtered <- data.frame(unperturbed.vs.control = anal.table.reg2$`Regulation.unperturbed vs control.s.log2FC`,
                     hl.vs.control = anal.table.reg2$`Regulation.HL vs control.s.log2FC`,
                     s.vs.control = anal.table.reg2$`Regulation.s vs control.s.log2FC`)
