...
ROPE outperforms DEseq2 as evidenced by ROC analysis (nope; ROPE mostly performs
worse than DESeq2. Although: the x axis says specificity. It's
supposed to be 1 - specificity. Is this just some weird nomenclature issue?)
...
ggroc(list(roc.rope.old.d, roc.deseq.old.d))
```
...
ggroc(list(roc.rope.new.d, roc.deseq.new.d))
```
...
ggroc(list(roc.rope.old.s, roc.deseq.old.s))
```
...
ggroc(list(roc.rope.new.s, roc.deseq.new.s))
