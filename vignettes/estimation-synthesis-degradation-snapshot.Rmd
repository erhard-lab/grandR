...
upper.s <- anal.table$`Regulation.s vs control.HL.conf.upper`
lower.s <- anal.table$`Regulation.s vs control.HL.conf.lower`

upper.d <- anal.table$`Regulation.HL vs control.HL.conf.upper`
lower.d <- anal.table$`Regulation.HL vs control.HL.conf.lower`
