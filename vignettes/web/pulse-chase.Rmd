...
d=ReadGRAND("/mnt/hilbert/projects/erhard/grandslam/ameres/chase_notrescued/grandslam_t15_fixedparam/chase_notrescued",
            design=c(NA,"Time",Design$Replicate),rename.sample=function(v) gsub(".chase","",gsub("0.5h","0_5h",v)))
d=FilterGenes(d)
d=Normalize(d)
```
...
We can also visualize single genes graphically:
...
PlotScatter(d,`kinetics.Half.life..h.`,`kinetics.Half-life`,correlation = FormatCorrelation())+geom_abline()
```
