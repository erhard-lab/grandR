...
```{r warning=FALSE, fig.alt = "Scatterplot SARS 4h A vs no4sU"}
...
```{r warning=FALSE, fig.alt = "Line plot for old, new and total RNA of SRSF6"}
...
```{r fig.alt = "Half-life distributins for 'kinetics' and 'restricted'"}
