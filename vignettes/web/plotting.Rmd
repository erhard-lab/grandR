...
```{r fig.width=6, warning=FALSE, fig.alt = "Basic scatter plots"}
...
```{r fig.width=6, warning=FALSE, fig.alt = "Colored old vs new scatter plot"}
...
```{r fig.width=6, warning=FALSE, fig.alt = "Colored old vs new scatter plot with credible intervals"}
...
```{r fig.width=6, warning=FALSE, fig.alt = "Grouped point plot"}
...
```{r fig.width=6, fig.alt = "Grouped bar plot"}
...
```{r fig.width=6, fig.alt = "Snapshot timecourse plot"}
...
```{r fig.width=6, fig.alt = "Progressive labeling plot"}
...
```{r fig.height=4, fig.width=4, fig.alt = "Scatter plot"}
...
```{r fig.height=4, fig.width=4, fig.alt = "Scatter plot (Vulcano)"}
...
```{r fig.height=6, fig.width=6, fig.alt = "Scatter plots"}
...
```{r fig.height=4, fig.width=4, fig.alt = "Scatter plot with highlight"}
...
```{r fig.height=4, fig.width=5, fig.alt = "Scatter plot with highlight"}
PlotScatter(banp,x=`total.6h vs 0h.LFC`,y=`total.2h vs 0h.LFC`,xlim=c(-2,0.5),ylim=c(-1,0.5),
            color = "BANP-Target")+
...
```{r fig.height=4, fig.width=5, fig.alt = "Scatter plot with correlation"}
PlotScatter(banp,x=`total.6h vs 0h.LFC`,y=`total.2h vs 0h.LFC`,xlim=c(-2,0.5),ylim=c(-1,0.5),
...
```{r fig.height=3, fig.width=6, fig.alt = "Scatter plot panels with correlation"}
PlotScatter(banp,x=`total.6h vs 0h.LFC`,y=`total.2h vs 0h.LFC`,xlim=c(-2,0.5),ylim=c(-1,0.5),
...
```{r fig.height=6, fig.width=6, fig.alt = "Heatmap"}
...
```{r eval=FALSE, fig.alt = "Scatter plots"}
...
```{r warning=FALSE, fig.alt = "Gene plots"}
...
```{r eval=FALSE, fig.alt = "Gene plots"}
