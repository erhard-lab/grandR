...
```{r fig.alt = "120min.A dropout plot"}
...
```{r fig.height=5, fig.width=5, fig.alt = "120min dropout scatter plot"}
...
```{r fig.alt = "dropout statistics"}
stat.r=ComputeSummaryStatistics(r,coldata=TRUE)

ggplot(stat.r,aes(duration.4sU,`4sU dropout`,group=Replicate))+
...
```{r fig.alt = "120min.A dropout plot after correction"}
...
```{r fig.height=5, fig.width=5, fig.alt = "120min dropout scatter plot after correction"}
